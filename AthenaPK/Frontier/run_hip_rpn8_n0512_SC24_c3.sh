...
export SCRIPTS_DIR="/lustre/orion/stf243/proj-shared/holmenjk/harness/frontier/athenapk/hip_rpn8_n0512_SC24_c3/Scripts"
export WORK_DIR="/lustre/orion/stf243/proj-shared/holmenjk/harness_sspace/frontier/03.18.24-13.15/athenapk/hip_rpn8_n0512_SC24_c3/1710786297.8174016/workdir"
export RESULTS_DIR="/lustre/orion/stf243/proj-shared/holmenjk/harness/frontier/athenapk/hip_rpn8_n0512_SC24_c3/Run_Archive/1710786297.8174016"
export HARNESS_ID="1710786297.8174016"
export BUILD_DIR="/lustre/orion/stf243/proj-shared/holmenjk/harness_sspace/frontier/03.18.24-13.15/athenapk/hip_rpn8_n0512_SC24_c3/1710786297.8174016/build_directory"
...
srun -n $NUM_PROC -N 512 --ntasks-per-node=${NUM_RANK_PER_NODE} --gpus-per-node=8 --gpu-bind=closest $BUILD_DIR/athenapk/build/bin/$EXECUTABLE \
