...
export SCRIPTS_DIR="/lustre/orion/stf243/proj-shared/holmenjk/harness/frontier/athenapk/hip_rpn8_n4096_SC24_c3/Scripts"
export WORK_DIR="/lustre/orion/stf243/proj-shared/holmenjk/harness_sspace/frontier/03.20.24-10.59/athenapk/hip_rpn8_n4096_SC24_c3/1710946798.4685218/workdir"
export RESULTS_DIR="/lustre/orion/stf243/proj-shared/holmenjk/harness/frontier/athenapk/hip_rpn8_n4096_SC24_c3/Run_Archive/1710946798.4685218"
export HARNESS_ID="1710946798.4685218"
export BUILD_DIR="/lustre/orion/stf243/proj-shared/holmenjk/harness_sspace/frontier/03.20.24-10.59/athenapk/hip_rpn8_n4096_SC24_c3/1710946798.4685218/build_directory"
...
srun -n $NUM_PROC -N 4096 --ntasks-per-node=${NUM_RANK_PER_NODE} --gpus-per-node=8 --gpu-bind=closest $BUILD_DIR/athenapk/build/bin/$EXECUTABLE \
