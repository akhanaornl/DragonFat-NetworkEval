...
export SCRIPTS_DIR="/lustre/orion/stf243/proj-shared/holmenjk/harness/frontier/athenapk/hip_rpn8_n9261_SC24_c3/Scripts"
export WORK_DIR="/lustre/orion/stf243/proj-shared/holmenjk/harness_sspace/frontier/03.27.24-20.11/athenapk/hip_rpn8_n9261_SC24_c3/1711584782.1067953/workdir"
export RESULTS_DIR="/lustre/orion/stf243/proj-shared/holmenjk/harness/frontier/athenapk/hip_rpn8_n9261_SC24_c3/Run_Archive/1711584782.1067953"
export HARNESS_ID="1711584782.1067953"
export BUILD_DIR="/lustre/orion/stf243/proj-shared/holmenjk/harness_sspace/frontier/03.27.24-20.11/athenapk/hip_rpn8_n9261_SC24_c3/1711584782.1067953/build_directory"
...
srun -n $NUM_PROC -N 9261 --ntasks-per-node=${NUM_RANK_PER_NODE} --gpus-per-node=8 --gpu-bind=closest $BUILD_DIR/athenapk/build/bin/$EXECUTABLE \
